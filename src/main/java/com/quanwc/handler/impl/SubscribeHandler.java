...
public class SubscribeHandler extends AbstractHandler {
    ...
    public WxMessage handle(WxMessage message) {
        ...
        WxMessage result =  initSubscribeText(toUserName, fromUserName, subscribeReplyText());
        return result;
    }
     ...
     * @return
     */
    private WxMessage initSubscribeText(String toUserName, String fromUserName, String content) {
    ...
    private String subscribeReplyText() {
        ...
        sb.append("往期文章戳 -->：<a href=\"https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=Mzg4NjAwMTQzMg==#wechat_redirect\">我的过去</a>\n");
